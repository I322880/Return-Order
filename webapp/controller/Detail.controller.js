sap.ui.define([
	...
	"sap/m/library",
	"sap/m/Popover"
], function (BaseController, JSONModel, formatter, mobileLibrary, popover) {
	"use strict";
	...
	return BaseController.extend("sap.ui.demo.orderbrowser.controller.Detail", {
		...
		_onBindingChange: function () {
			...
			oViewModel.setProperty("/shareSendEmailMessage",
				oResourceBundle.getText("shareSendEmailObjectMessage", [sObjectName, sObjectId, location.href, oObject.ShipName, oObject.EmployeeID,
					oObject.CustomerID
				]));
		},
